...
public interface CityMapper {
    ...
    @Select("SELECT \n" +
            ...
            "reviser AS reviser \n" +
            "from t_record_info where state_flag=2 and region_emp_name like CONCAT('%',#{param2},'%') \n" +
    ...
    @Select("SELECT \n" +
            ...
            "revise_time AS reviseTIme, \n" +
            "reviser AS reviser \n" +
            "from t_record_info where state_flag=2 and region_name like CONCAT('%',#{param2},'%') \n" +
            "and region_emp_id in (select user_id from t_user where superior=#{param1});")
    ...
    @Select("SELECT \n" +
            ...
            "revise_time AS reviseTIme, \n" +
            "reviser AS reviser \n" +
            "from t_record_info where state_flag=2 and region_emp_contact like CONCAT('%',#{param2},'%') \n" +
            "and region_emp_id in (select user_id from t_user where superior=#{param1});")
